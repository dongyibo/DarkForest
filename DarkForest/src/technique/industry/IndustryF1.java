...
public class IndustryF1 extends Technique{
	public static final IndustryF1 industryF1=new IndustryF1();
	
	private static final String name="水滴";
	
	//建造点数
	private static final long neededPoint=1000;
	private static final String property="industry";
	private static final long priority=75;
	//完成后的加成
