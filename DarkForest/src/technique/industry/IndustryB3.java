...
public class IndustryB3 extends Technique{
	public static final IndustryB3 industryB3=new IndustryB3();
	
	private static final String name="浑天仪";
	
	//建造点数
	private static final long neededPoint=200;
	private static final String property="industry";
	private static final long priority=25;
	//完成后的加成
	private static final long decreaseResourse=0;
	private static final long addResourseDecrease=0;
	private static final long addScience=12;
