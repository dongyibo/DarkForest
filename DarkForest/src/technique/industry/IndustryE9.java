...
public class IndustryE9 extends Technique{
	public static final IndustryE9 industryE9=new IndustryE9();
	
	private static final String name="太空城";
	...
	//完成后的加成
	private static final long decreaseResourse=600;
	private static final long addResourseDecrease=-3;
...
//	private static final long addIndustryIncrease=1;
	...
	private static final Technique[] unlockTechnique={IndustryE9.industryE9}; 
