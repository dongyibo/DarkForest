...
public class IndustryE1 extends Technique{
	public static final IndustryE1 industryE1=new IndustryE1();
	
	private static final String name="分子熔炉";
	
	//建造点数
	private static final long neededPoint=1000;
	private static final String property="industry";
	private static final long priority=44;
	//完成后的加成
...
//	private static final long addIndustryIncrease=1;
	...
	private static final Technique[] unlockTechnique={IndustryE1.industryE1}; 
