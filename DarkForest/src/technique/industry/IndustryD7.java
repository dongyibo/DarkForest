...
import technique.science.ScienceD7;

public class IndustryD7 extends Technique{
	public static final IndustryD7 industryD7=new IndustryD7();
	
	private static final String name="深空望远镜";
	
	//建造点数
	private static final long neededPoint=400;
	private static final String property="industry";
	private static final long priority=55;
	//完成后的加成
...
//	private static final long addIndustryIncrease=1;
	...
	private static final Technique[] unlockTechnique={ScienceD7.scienceD7}; 
