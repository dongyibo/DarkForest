...
public class IndustryE7 extends Technique{
	public static final IndustryE7 industryE7=new IndustryE7();
	
	private static final String name="人工生殖舱";
	
	//建造点数
	private static final long neededPoint=1300;
	private static final String property="industry";
	private static final long priority=47;
	//完成后的加成
