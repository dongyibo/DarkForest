...
public class IndustryC1 extends Technique{
	public static final IndustryC1 industryC1=new IndustryC1();
	
	private static final String name="蒸汽机";
	
	//建造点数
	private static final long neededPoint=300;
	private static final String property="science";
	private static final long priority=60;
	//完成后的加成
