...
public class ScienceD7 extends Technique{

	public static final ScienceD7 scienceD7=new ScienceD7();
	
	private static final String name="黑暗森林理论";
	
	//建造点数
	private static final long neededPoint=2000;
	private static final String property="science";
	private static final long priority=99;
	//完成后的加成
	...
	private static final long addIndustry=1;
