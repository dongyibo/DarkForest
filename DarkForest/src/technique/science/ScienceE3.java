...
public class ScienceE3 extends Technique{
	public static final ScienceE3 scienceE3=new ScienceE3();
	
	private static final String name="物质深层结构III";
	
	//建造点数
	private static final long neededPoint=12000;
...
//	private static final long addIndustryIncrease=0;
	...
	private static final Technique[] unlockTechnique={ScienceF1.scienceF1}; 
